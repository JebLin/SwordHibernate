package indi.sword.hibernate.n21.both;
...
public class Test01 extends BaseTest{
	...
	public void testUpdate2(){
		...
		System.out.println("--------------------------------------------------");
		// 必定 2 个select
		// 如果 orderName有变化的才 会有 update 语句
		customer.getOrders().iterator().next().setOrderName("qqq");
	}
	...
	public void testMany2OneGet(){
		...
		System.out.println(order.getCustomer().getClass().getName()); // 返回一个代理对象
